...
export const RippleButton = ({style, textcolor, onClick, content, disabled})=>{
    ...
    return (
        <Pressable style={{...mystyles.pressable, ...styles.button, ...style}} onPress={onClick} disabled={disabled} onLayout={(e)=>{setButtonWidth(e.nativeEvent.layout.width);}} onPressIn={startRipple} onPressOut={()=>{callCleanUp(2000)}}>
            <Text style={{color:textcolor || '#ffffff'}}>{content}</Text>
